...
function switchMobile(change = true) {
    ...
    if (data.settings.mobile) {
        ...
        document.getElementById("mobileStylesheet").setAttribute('href', 'css/unset.css');
...
function switchTextShadow(change) {
    ...
    if (data.settings.textShadow == 0) {
        document.getElementById("themeTextShadowStylesheet").setAttribute("href", "css/unset.css")
...
function switchSmoothWidth(change = true) {
    ...
    if (data.settings.smoothWidth) {
        ...
        document.getElementById("smoothWidthStylesheet").setAttribute("href", "css/unset.css")
